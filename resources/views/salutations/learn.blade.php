...
<head>
    ...
    <title>Salutations - BiLangue</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="word-card" id="wordCard">
            ...
            <div class="word-row">
                ...
                <div class="word-col to">
                    ...
                    <div class="word to" id="toWord">{{ $salutations->first()->{$toColumn} ?? '' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-nav">
            ...
            <div class="card-counter">
                <span id="currentIndex">1</span> / <span id="totalCards">{{ $salutations->count() }}</span>
            </div>
    ...
    <script>
        ...
        function updateCard() {
            ...
            // Update content
            const item = salutations[currentIndex];
            ...
            // Check if last card
            if (currentIndex === salutations.length - 1) {
            ...
            // Update progress
            const progress = ((currentIndex + 1) / salutations.length) * 100;
