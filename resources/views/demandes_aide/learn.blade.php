...
<head>
    ...
    <title>Demandes d'Aide - BiLangue</title>
...
<body>
    ...
    <div class="container">
        <div class="word-card" id="wordCard">
            ...
            <div class="word-row">
                ...
                <div class="word-col to">
                    ...
                    <div class="word to" id="toWord">{{ $demandes->first()->{$toColumn} ?? '' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-nav">
            ...
            <div class="card-counter">
                <span id="currentIndex">1</span> / <span id="totalCards">{{ $demandes->count() }}</span>
            </div>
    ...
    <script>
        ...
        function updateCard() {
            ...
            const item = demandes[currentIndex];
            ...
            if (currentIndex === demandes.length - 1) {
            ...
            const progress = ((currentIndex + 1) / demandes.length) * 100;
