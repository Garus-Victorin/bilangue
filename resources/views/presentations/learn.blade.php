...
<head>
    ...
    <title>Présentations - BiLangue</title>
...
<body>
    ...
    <div class="container">
        <div class="word-card" id="wordCard">
            ...
            <div class="word-row">
                ...
                <div class="word-col to">
                    ...
                    <div class="word to" id="toWord">{{ $presentations->first()->{$toColumn} ?? '' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-nav">
            ...
            <div class="card-counter">
                <span id="currentIndex">1</span> / <span id="totalCards">{{ $presentations->count() }}</span>
            </div>
    ...
    <script>
        ...
        function updateCard() {
            ...
            const progress = ((currentIndex + 1) / presentations.length) * 100;
