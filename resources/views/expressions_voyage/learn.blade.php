...
<head>
    ...
    <title>Expressions Voyage - BiLangue</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="word-card" id="wordCard">
            ...
            <div class="word-row">
                ...
                <div class="word-col to">
                    ...
                    <div class="word to" id="toWord">{{ $expressions->first()->{$toColumn} ?? '' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-nav">
            ...
            <div class="card-counter">
                <span id="currentIndex">1</span> / <span id="totalCards">{{ $expressions->count() }}</span>
            </div>
    ...
    <script>
        ...
        function updateCard() {
            ...
            // Update progress
            const progress = ((currentIndex + 1) / expressions.length) * 100;
