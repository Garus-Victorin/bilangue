...
<body>
    ...
    <div class="container">
        <div class="word-card" id="wordCard">
            ...
            <div class="nombre-badge" id="nombreBadge">{{ $nombres->first()->nombre ?? '' }}</div>
            
            <div class="word-row">
                <div class="word-col from">
                    <div class="lang-label from">{{ ucfirst($fromLang) }}</div>
                    <div class="word from" id="fromWord">{{ $nombres->first()->{$fromColumn} ?? '' }}</div>
                </div>
                ...
                <div class="word-col to">
                    ...
                    <div class="word to" id="toWord">{{ $nombres->first()->{$toColumn} ?? '' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-nav">
            ...
            <div class="card-counter">
                <span id="currentIndex">1</span> / <span id="totalCards">{{ $nombres->count() }}</span>
            </div>
    ...
    <script>
        ...
        function updateCard() {
            ...
            const item = nombres[currentIndex];
            fromWord.textContent = item[fromColumn] || '';
            toWord.textContent = item[toColumn] || '';
            nombreBadge.textContent = item.nombre || '';
            
            currentIndexEl.textContent = currentIndex + 1;
            
            prevBtn.disabled = currentIndex === 0;
            
            if (currentIndex === nombres.length - 1) {
            ...
            const progress = ((currentIndex + 1) / nombres.length) * 100;
