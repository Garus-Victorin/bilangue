...
<head>
    ...
    <title>Phrases Basiques - BiLangue</title>
    ...
    <div class="container">
        <div class="word-card" id="wordCard">
            ...
            <div class="word-row">
                ...
                <div class="word-col to">
                    ...
                    <div class="word to" id="toWord">{{ $phrases->first()->{$toColumn} ?? '' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-nav">
            ...
            <div class="card-counter">
                <span id="currentIndex">1</span> / <span id="totalCards">{{ $phrases->count() }}</span>
            </div>
