...
<head>
    ...
    <title>Parties du Corps - BiLangue</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="word-card" id="wordCard">
            <div class="emoji-label">Partie du Corps</div>
            <div class="emoji-badge" id="emojiBadge">🗣️</div>
            
            <div class="word-row">
                <div class="word-col from">
                    <div class="lang-label from">{{ ucfirst($fromLang) }}</div>
                    <div class="word from" id="fromWord">{{ $parties->first()->{$fromColumn} ?? '' }}</div>
                </div>
                ...
                <div class="word-col to">
                    ...
                    <div class="word to" id="toWord">{{ $parties->first()->{$toColumn} ?? '' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-nav">
            ...
            <div class="card-counter">
                <span id="currentIndex">1</span> / <span id="totalCards">{{ $parties->count() }}</span>
            </div>
    ...
    <script>
        ...
        function updateCard() {
            ...
            // Update content
            const item = parties[currentIndex];
            const fromText = item[fromColumn] || '';
            fromWord.textContent = fromText;
            toWord.textContent = item[toColumn] || '';
            
            // Update emoji from database
            emojiBadge.textContent = item.emoji || '🗣️';
            ...
            // Update progress
            const progress = ((currentIndex + 1) / parties.length) * 100;
